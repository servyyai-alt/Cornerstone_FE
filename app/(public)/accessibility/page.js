...
const commitmentItems = [
  {
    ...
    body:
      'Cornerstone is committed to making our website and key enquiry journeys accessible to as many people as possible, including users who rely on keyboard navigation, screen readers, magnification, or high-contrast display settings.',
  },
  {
    title: 'What we aim to support',
    body:
      'We aim to use clear page structure, descriptive headings, meaningful link text, visible focus states, readable color contrast, and form labels that make it easier to move through the site and submit enquiries.',
  },
  {
    title: 'Technical approach',
    body:
      'The site is built with semantic HTML, ARIA where helpful, and responsive layouts. We test the public pages on current desktop and mobile browsers and we review the main journeys regularly as content changes.',
  },
  {
    title: 'Known limitations',
    body:
      'Some third-party embeds, external documents, or partner-hosted resources may not always meet the same standard as the Cornerstone website. When this happens, we try to provide a suitable alternative or a contact route for assistance.',
  },
];
