  ...
  return (
    <main className="flex-1 bg-background text-foreground pb-24">
      ...
      <Container className="mb-12">
        <div className="rounded-xl border border-border bg-surface p-6 shadow-sm space-y-6 transition-all duration-300 hover:border-primary/30 hover:shadow-[0_16px_32px_-10px_rgba(185,151,80,0.06)]">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((uni) => (
              <div 
                ...
                className="glass-card rounded-xl p-6 cursor-pointer hover:border-primary/60 hover:shadow-[0_20px_40px_-12px_rgba(185,151,80,0.12)] flex flex-col justify-between"
              >
                <div>
